...
const Appbar = _ref => {
  ...
  let isDark;
  const backgroundColor = (0, _utils.getAppbarColor)(theme, elevation, customBackground, elevated);
  ...
  const filterAppbarActions = React.useCallback(function () {
    ...
    return React.Children.toArray(children).filter(child => // @ts-expect-error: TypeScript complains about the type of type but it doesn't matter

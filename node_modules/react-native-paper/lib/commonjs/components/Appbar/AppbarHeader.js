...
const AppbarHeader = _ref => {
  ...
  const backgroundColor = (0, _utils.getAppbarColor)(rest.theme, elevation, customBackground, elevated); // Let the user override the behaviour

  const Wrapper = typeof statusBarHeight === 'number' ? _reactNative.View : _reactNative.SafeAreaView;

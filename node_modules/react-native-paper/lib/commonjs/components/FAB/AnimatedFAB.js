...
const AnimatedFAB = _ref => {
  ...
  const rippleColor = (0, _color.default)(foregroundColor).alpha(0.12).rgb().string();
  ...
  return /*#__PURE__*/React.createElement(_Surface.default, _extends({}, rest, {
    ...
    pointerEvents: "none",
    style: [_reactNative.StyleSheet.absoluteFill, disabled ? styles.disabled : styles.shadow, {
      width: extendedWidth,

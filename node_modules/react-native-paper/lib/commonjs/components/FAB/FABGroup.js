...
const FABGroup = _ref => {
  ...
  return /*#__PURE__*/React.createElement(_reactNative.View, {
    ...
    return /*#__PURE__*/React.createElement(_reactNative.View, {
      ...
      ,
      style: [styles.item, {
        marginHorizontal: typeof it.size === 'undefined' || it.size === 'small' ? 24 : 16
      }],
      pointerEvents: open ? 'box-none' : 'none'
    }, it.label && /*#__PURE__*/React.createElement(_reactNative.View, null, /*#__PURE__*/React.createElement(_Card.default, _extends({
      style: [styles.label, {
        transform: [isV3 ? {
        ...
        opacity: opacities[i]
      }, isV3 && styles.v3LabelStyle, it.labelStyle],
      onPress: () => {
        it.onPress();
        close();
      },

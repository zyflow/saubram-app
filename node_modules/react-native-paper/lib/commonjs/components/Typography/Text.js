...
const Text = (_ref, ref) => {
  ...
  const root = React.useRef(null); // FIXME: destructure it in TS 4.6+

  const theme = (0, _theming.useTheme)(initialTheme);
  ...
  if (theme.isV3 && variant) {
    const stylesByVariant = Object.keys(_types.MD3TypescaleKey).reduce((acc, key) => {
      ...
      return { ...acc,
        [key]: { ...(_reactNative.Platform.OS === 'android' && {
            fontFamily
          }),
          fontSize,
          fontWeight,
    ...
    return /*#__PURE__*/React.createElement(_reactNative.Text, _extends({}, rest, {
      ref: root,
      style: [{ ...(!theme.isV3 && ((_theme$fonts = theme.fonts) === null || _theme$fonts === void 0 ? void 0 : _theme$fonts.regular)),

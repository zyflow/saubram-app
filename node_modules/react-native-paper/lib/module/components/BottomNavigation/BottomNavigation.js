...
const BottomNavigation = _ref3 => {
  ...
  const inactiveTintColor = typeof inactiveColor !== 'undefined' ? inactiveColor : isV3 ? theme.colors.onSurfaceVariant : color(textColor).alpha(0.5).rgb().string();
  ...
  return /*#__PURE__*/React.createElement(View, {
    ...
    const v3InactiveOpacity = shifting ? inactiveOpacity : focused ? 0 : 1; // Scale horizontally the outline pill
    ...
    return renderTouchable({
      ...
      }, isV3 && /*#__PURE__*/React.createElement(Animated.View, {

...
const SegmentedButtons = _ref => {
  ...
  return /*#__PURE__*/React.createElement(View, {
    ...
    const onPress = e => {
      ...
      const nextValue = multiSelect && Array.isArray(value) ? checked ? value.filter(val => item.value !== val) : [...value, item.value] : item.value; // @ts-expect-error: TS doesn't preserve types after destructuring, so the type isn't inferred correctly
...
export default SegmentedButtons; // @component-docs ignore-next-line

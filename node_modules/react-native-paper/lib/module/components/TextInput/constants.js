...
export const ADORNMENT_SIZE = 24; //Text input affix offset

export const MD2_AFFIX_OFFSET = 12;
export const MD3_AFFIX_OFFSET = 16; // Text input icon

export const ICON_SIZE = 24;
export const MD2_ICON_OFFSET = 12;
export const MD3_ICON_OFFSET = 16; // Text input common

export const MD2_MIN_HEIGHT = 64;
export const MD3_MIN_HEIGHT = 56;
export const MD3_ADORNMENT_OFFSET = 16;
export const MD2_ADORNMENT_OFFSET = 12; // Text input flat
...
export const MIN_DENSE_HEIGHT = 40; // Text input outlined

export const MD2_INPUT_PADDING_HORIZONTAL = 14;
export const MD3_INPUT_PADDING_HORIZONTAL = 16; // extra space to avoid overlapping input's text and icon

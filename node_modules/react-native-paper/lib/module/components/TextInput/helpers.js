...
const getFlatBackgroundColor = _ref11 => {
...
const getFlatUnderlineColor = _ref12 => {
  let {
    theme,
    disabled,
    underlineColor
...
const getOutlinedOutlineInputColor = _ref13 => {
  let {
    theme,
    disabled,
    customOutlineColor
...
export const getFlatInputColors = _ref14 => {
  let {
    underlineColor,
    activeUnderlineColor,
    disabled,
  ...
  return {
    inputTextColor: getInputTextColor({ ...baseFlatColorProps,
      mode: 'flat'
    }),
    activeColor: getActiveColor({ ...baseFlatColorProps,
      error,
      activeUnderlineColor,
      mode: 'flat'
    }),
    underlineColorCustom: getFlatUnderlineColor({ ...baseFlatColorProps,
      underlineColor
    }),
...
export const getOutlinedInputColors = _ref15 => {
  let {
    activeOutlineColor,
    customOutlineColor,
    disabled,
  ...
  return {
    inputTextColor: getInputTextColor({ ...baseOutlinedColorProps,
      mode: 'outlined'
    }),
    activeColor: getActiveColor({ ...baseOutlinedColorProps,
      error,
      activeOutlineColor,
      mode: 'outlined'
    }),
    outlineColor: getOutlinedOutlineInputColor({ ...baseOutlinedColorProps,
      customOutlineColor
    }),
...
export const getConstants = isV3 => {
  // Text input affix
  let AFFIX_OFFSET; // Text input icon

  let ICON_OFFSET; //Text input flat

  let LABEL_PADDING_TOP;
  let LABEL_PADDING_HORIZONTAL;
  let FLAT_INPUT_OFFSET;
  let MIN_HEIGHT; // Text input outlined;

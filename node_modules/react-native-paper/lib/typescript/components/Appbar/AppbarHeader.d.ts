...
declare const _default: React.ComponentType<(Pick<Pick<Partial<import("react-native").ViewProps & React.RefAttributes<View>> & {
    ...
    theme: Theme;
    style?: StyleProp<ViewStyle>;
}, "dark" | keyof import("react-native").ViewProps | "mode" | keyof React.RefAttributes<View> | "elevated" | "safeAreaInsets" | "statusBarHeight"> | Pick<Pick<Partial<import("react-native").ViewProps & React.RefAttributes<View>> & {
    dark?: boolean | undefined;
    children: React.ReactNode;
    mode?: "small" | "medium" | "large" | "center-aligned" | undefined;
    elevated?: boolean | undefined;

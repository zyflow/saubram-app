...
declare const Appbar: (import("react").ComponentType<Pick<Partial<import("react-native").ViewProps & import("react").RefAttributes<import("react-native").View>> & {
    ...
    Action: {
        ({ size, color: iconColor, icon, disabled, onPress, accessibilityLabel, isLeading, ...rest }: import("./AppbarAction").Props): JSX.Element;
        displayName: string;
    };
    BackAction: {
    ...
    Header: import("react").ComponentType<(Pick<Pick<Partial<import("react-native").ViewProps & import("react").RefAttributes<import("react-native").View>> & {
        ...
        theme: import("../..").Theme;
        style?: import("react-native").StyleProp<import("react-native").ViewStyle>;
    }, "dark" | keyof import("react-native").ViewProps | "mode" | keyof import("react").RefAttributes<import("react-native").View> | "elevated" | "safeAreaInsets" | "statusBarHeight"> | Pick<Pick<Partial<import("react-native").ViewProps & import("react").RefAttributes<import("react-native").View>> & {
        dark?: boolean | undefined;
        children: import("react").ReactNode;
        mode?: "small" | "medium" | "large" | "center-aligned" | undefined;
        elevated?: boolean | undefined;

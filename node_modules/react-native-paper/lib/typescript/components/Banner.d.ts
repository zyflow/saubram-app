...
declare const _default: React.ComponentType<Pick<$RemoveChildren<({ elevation, children, theme: overridenTheme, style, testID, ...props }: import("./Surface").Props) => JSX.Element> & {
    ...
    actions: ({
        label: string;
    } & Omit<(Pick<import("react-native").ViewProps & React.RefAttributes<View> & {
        ...
        theme: Theme;
        testID?: string | undefined;
    }, "dark" | "color" | "onPress" | "onPressIn" | "onPressOut" | "onLongPress" | "icon" | "elevation" | keyof import("react-native").ViewProps | "mode" | keyof React.RefAttributes<View> | "uppercase" | "labelStyle" | "disabled" | "compact" | "loading" | "buttonColor" | "textColor" | "contentStyle"> & {

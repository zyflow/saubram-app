...
declare const _default: React.ComponentType<Pick<import("react-native").ViewProps & React.RefAttributes<View> & {
     ...
     */
    testID?: string | undefined;
}> & (({ disabled, compact, mode, dark, loading, icon, buttonColor: customButtonColor, textColor: customTextColor, children, accessibilityLabel, accessibilityHint, onPress, onPressIn, onPressOut, onLongPress, style, theme, uppercase, contentStyle, labelStyle, testID, accessible, ...rest }: Props) => JSX.Element), {}>;

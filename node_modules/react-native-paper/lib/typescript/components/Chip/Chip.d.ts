...
declare const _default: React.ComponentType<Pick<import("react-native").ViewProps & React.RefAttributes<View> & {
...
}, "ellipsizeMode" | "onPress" | "onLongPress" | "icon" | "elevation" | keyof import("react-native").ViewProps | "mode" | keyof React.RefAttributes<View> | "disabled" | "selected" | "elevated" | "compact" | "selectedColor" | "showSelectedOverlay" | "avatar" | "closeIconAccessibilityLabel" | "onClose" | "closeIcon" | "textStyle"> & {
     ...
     */
    ellipsizeMode?: EllipsizeProp | undefined;
}> & (({ mode, children, icon, avatar, selected, disabled, accessibilityLabel, closeIconAccessibilityLabel, onPress, onLongPress, onClose, closeIcon, textStyle, style, theme, testID, selectedColor, showSelectedOverlay, ellipsizeMode, compact, elevated, ...rest }: Props) => JSX.Element), {}>;

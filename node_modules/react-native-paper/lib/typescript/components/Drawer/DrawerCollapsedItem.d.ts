...
declare const _default: React.ComponentType<Pick<import("react-native").ViewProps & React.RefAttributes<View> & {
...
}, "label" | "onPress" | "icon" | keyof import("react-native").ViewProps | keyof React.RefAttributes<View> | "active" | "badge"> & {
    ...
    ({ icon, label, active, theme, style, onPress, accessibilityLabel, badge, ...rest }: Props): JSX.Element | null;
    displayName: string;
}, {}>;

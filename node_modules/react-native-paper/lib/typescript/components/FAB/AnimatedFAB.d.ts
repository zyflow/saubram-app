...
declare const _default: React.ComponentType<Pick<$RemoveChildren<({ elevation, children, theme: overridenTheme, style, testID, ...props }: import("../Surface").Props) => JSX.Element> & {
     ...
     * Color mappings variant for combinations of container and icon colors.
     */
    variant?: "primary" | "secondary" | "tertiary" | "surface" | undefined;
    style?: StyleProp<ViewStyle>;
    /**
     * @optional
     */
    ...
    theme: Theme;
    testID?: string | undefined;
}> & (({ icon, label, accessibilityLabel, accessibilityState, color: customColor, disabled, onPress, onLongPress, theme, style, visible, uppercase, testID, animateFrom, extended, iconMode, variant, ...rest }: Props) => JSX.Element), {}>;

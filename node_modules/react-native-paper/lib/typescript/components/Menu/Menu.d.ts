...
declare class Menu extends React.Component<Props, State> {
    static Item: React.ComponentType<Pick<import("./MenuItem").Props, "style" | "title" | "onPress" | "testID" | "accessibilityLabel" | "disabled" | "titleStyle" | "contentStyle" | "leadingIcon" | "trailingIcon" | "dense"> & {

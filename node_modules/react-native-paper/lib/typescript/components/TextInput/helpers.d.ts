...
export declare const getFlatInputColors: ({ underlineColor, activeUnderlineColor, disabled, error, theme, }: {
...
export declare const getOutlinedInputColors: ({ activeOutlineColor, customOutlineColor, disabled, error, theme, }: {
...
export declare const getConstants: (isV3?: boolean | undefined) => {
    AFFIX_OFFSET: number;
    ICON_OFFSET: number;
